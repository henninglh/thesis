...
% Cite "modeling genomic regularity networks with big data"
...
%    \item For example, if protein A induces expression of protein B, then we expect to see high levels of protein B
...
% Find a way to prove that, by severing the interaction bond between
% genes/proteines, you can stop cancer biomarkers from "communicating
...
% Rename the Cytoscape section to Software/Architecture/Development General
