...
data and formatting scripts used in this assignment. The movember data refers to
a list of genes of potential interest in prostate cancer from a researcher at
the Movember group named Kristin Tasken, and can therefore only be retrieved
through her or the GitHub repository mentioned below.
