...
\begin{sidewaysfigure}
    ...
    \caption{Distribution of average combined genes, which had their scores
...
completes the values for the y-axis in the plot represents the score in
a cluster when additively combining the averages from each of the 10
cross-validated results that was found by \gls{prwp}.
