...
\begin{sidewaystable}
    \begin{tabular}{|l|l|l|l|l|}
        ...
        \hline
    \end{tabular}
    \caption{iRefWeb network ranked with PRWP and movember data}
...
\begin{sidewaystable}
    \begin{tabular}{|l|l|l|l|l|}
        ...
        \hline
    \end{tabular}
    \caption{iRefWeb network ranked with MAA and movember data}
...
\begin{sidewaystable}
    \begin{tabular}{|l|l|l|l|l|}
        ...
        \hline
    \end{tabular}
    \caption{iRefWeb network ranked with PRWP and COSMIC data}
...
\begin{sidewaystable}
    \begin{tabular}{|l|l|l|l|l|}
        ...
        \hline
    \end{tabular}
    \caption{iRefWeb network ranked with MAA and COSMIC data}
