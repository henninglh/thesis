...
contained genes from the Movember data set. The PRTN3 gene is the only one not
associated with prostate cancer according to the DISEASE database and the golden
standard. This could be a possible candidate prostate cancer biomarker, due to
the earlier mentioned "guilt-by-association" principle. It could also be
